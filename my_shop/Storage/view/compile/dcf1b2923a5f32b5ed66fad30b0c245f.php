...
<html>
	...
	<body>
		<a href="<?php echo U('Type/index')?>" class="btn btn-sm btn-info">返回上一步</a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		<a href="<?php echo U('add',array('tid'=>$tid))?>" class="btn btn-sm btn-info">添加属性</a>
		<br />
		...
		<table class="table table-hover">
			...
			<tr>
               ...
               <?php }?>
				...
				<td>
					<a href="<?php echo U('edit',array('taid'=>$v['taid'],'tid'=>$tid))?>" class="btn btn-sm btn-warning">编辑</a>
					<a href="javascript:;" class="btn btn-sm btn-danger" onclick="if(confirm('确定删除吗')) location.href='<?php echo U('del',array('taid'=>$v['taid']))?>'">删除</a>					
				</td>
			</tr>
			<?php }?>
