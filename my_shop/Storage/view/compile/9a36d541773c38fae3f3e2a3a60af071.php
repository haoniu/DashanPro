...
<html>
	...
	<body>
		<form onsubmit="return hd_submit(this,'<?php echo U("Category/edit")?>','<?php echo U("Category/index")?>')">
			...
			<div class="form-group">
				...
				<select name="type_tid" class="form-control">
					...
					<option value="<?php echo $v['tid']?>" <?php if($type_tid==$v['tid']){?>
                selected
			...
			<div class="form-group">
				...
				<input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入排序号码"  name="csort" value="<?php echo $oldData['csort']?>">
			</div>
