...
<script type="text/javascript">
	...
	<div id="my-shop">
		...
		<div class="my-orders">
			<div class="title">
				&nbsp;&nbsp;&nbsp;<span>时间：<?php echo date('Y-m-d H:i:s',$v['sendtime'])?></span>&nbsp;&nbsp;&nbsp;&nbsp;
				<span>订单号：<?php echo $v['number']?></span><span><a href="<?php echo U('details',array('oid'=>$v['oid']))?>" style="float: right;">订单详情</a></span>
			</div>
			<?php foreach ($v['details'] as $v){?>
			<div class="con">
				<ul>
					<div class="pic">
						<img src="<?php echo __ROOT__?>/<?php echo $v['pic']?>"/>
					</div>
					<li class="name">
					...
					<li class="num">
						<p>总数量：<?php echo $v['num']?></p>
					</li>
					<li class="all-price">
						<p>金额：¥ <?php echo $v['subtotal']?></p>
					</li>
					<li class="info">
