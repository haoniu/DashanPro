...
<script type="text/javascript">
	...
	<div id="my-shop">
		...
		<!--我的订单详情-->
		<div class="my-orders">
			<p>收货人姓名：<?php echo $orderData['consignee']?></p>
			<br />
			<p>送货地址：<?php echo $orderData['add']?></p>
			<br />
			<p>收货人电话：<?php echo $orderData['mobile']?></p>
			<br />
			<p>订单状态：<span style="color: red;"><?php if($orderData['status']==1){?>
                未付款
               <?php }?>
