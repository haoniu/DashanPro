...
<link href="<?php echo __PUBLIC__?>/Admin/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN LOGO -->
<div class="logo">
	<img src="<?php echo __PUBLIC__?>/Admin/assets/admin/layout/img/logo-big.png" alt=""/>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
...
<script src="<?php echo __PUBLIC__?>/Admin/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="<?php echo __PUBLIC__?>/Admin/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
