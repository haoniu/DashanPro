...
<html>
	...
	<body>
		<form onsubmit="return hd_submit(this,'<?php echo U("Order/delivery")?>','<?php echo U("Order/send")?>')">
			<div class="alert alert-success">发送货品</div>
			<p class="bg-info">当前订单号：<?php echo $oldData['number']?></p>
			...
			<input type="hidden" name="oid" id="" value="<?php echo $oid?>" />
