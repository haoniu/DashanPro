	...
	<body>
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<label>属性：<input id="exampleInputEmail1" class="" type="radio" name="class" value="0"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></label>
				<label>规格：<input id="exampleInputEmail1" class="" type="radio" name="class" value="1"></label>
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">属性值</label>
				<textarea name="tavalue" rows="5" cols=""  class="form-control" placeholder="请输入属性值，输入多个，请用|分开"></textarea>
			</div>
